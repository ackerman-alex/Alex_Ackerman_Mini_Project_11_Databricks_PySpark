...
if __name__ == "__main__":
    ...
    assert results["extract_to"] == "data/Spotify_Most_Streamed_Songs.csv", "Extraction path mismatch"
    assert results["transform_db"] == "output/Spotify_Transformed.parquet", "Transformation output path mismatch"
